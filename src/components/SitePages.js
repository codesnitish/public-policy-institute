                  ...
                  children: _jsxs(CardContent, {
                    ...
                    children: [
                      ...
                      _jsx(Typography, {
                        ...
                        children:
                          "We imagine a world where decisions are guided by evidence, opportunities are shared fairly, and every person \u2014 across genders, communities, and backgrounds \u2014 has the chance to thrive. A world where systems are inclusive, progress is sustainable, and innovation works for everyone.",
                      }),
                    ],
                  }),
                }),
                      ...
                      _jsxs(Stack, {
                        ...
                        children: [
                          _jsx(Typography, {
                            ...
                            children:
                              "Producing and applying evidence that shapes fair and effective policies and practices",
                          }),
                          _jsx(Typography, {
                            sx: { color: "text.secondary" },
                            children:
                              "Centering people of all genders in the design of solutions and systems",
                          }),
                          _jsx(Typography, {
                            sx: { color: "text.secondary" },
                            children:
                              "Collaborating across sectors to address structural inequalities together",
                          }),
                          _jsx(Typography, {
                            sx: { color: "text.secondary" },
                            children:
                              "Promoting context-aware, sustainable approaches that create long-term impact",
                          }),
                        ],
                      }),
                    ],
        ...
        children: _jsxs(Container, {
          ...
          children: [
            ...
            _jsx(Grid, {
              ...
              spacing: 2.5,
              sx: { mt: 2.5 },
              children: visibleBlogs.map((b) =>
                _jsx(
                  Grid,
                  {
                    size: { xs: 12, md: 6 },
                    sx: { display: "flex" },
                    children: _jsx(BlogCard, { blog: b, height: 220 }),
                  },
                  b.slug,
                ),
              ),
  ...
  return _jsx(Box, {
    ...
    children: _jsxs(Container, {
      ...
      children: [
        ...
        _jsx(Stack, {
          spacing: 1.2,
          children: whatWeDoItems.map((item) =>
            _jsxs(
              Typography,
              { sx: { color: "text.secondary" }, children: ["\u2022 ", item] },
              item,
            ),
          ),
        }),
        _jsx(Typography, {
          sx: { color: "text.secondary", lineHeight: 1.9, mt: 3 },
          children:
        ...
        _jsx(Typography, {
          sx: { color: "text.secondary", lineHeight: 1.9, mt: 2 },
          children:
    ...
    children: _jsxs(Container, {
      ...
      children: [
        ...
        _jsx(Grid, {
          container: true,
          spacing: 3,
          children: guidelineSections.map((section) =>
            _jsx(
              Grid,
              {
                size: { xs: 12, md: 6 },
                  ...
                  children: _jsxs(CardContent, {
                    ...
                    children: [
                      ...
                      _jsx(Stack, {
                        spacing: 1,
                        sx: { mb: 2.5 },
                        children: section.bullets.map((item) =>
                          _jsxs(
                            Typography,
                            {
                      ...
                      _jsx(Typography, {
                        ...
                        children: "APA 7th Edition Formatting",
                      }),
                      _jsx(Stack, {
                        spacing: 0.8,
                        children: section.formatting.map((item) =>
                          _jsxs(
                            Typography,
                            {
                              sx: { color: "text.secondary", lineHeight: 1.8 },
                        ...
                        ? _jsxs(_Fragment, {
                            children: [
                              ...
                              _jsx(Typography, {
                                ...
                                children: "Reference Resources",
                              }),
                              _jsx(Stack, {
                                spacing: 0.8,
                                children: section.resources.map((item) =>
                                  _jsxs(
                                    Typography,
                                    {
                                      sx: {
      ...
      children: [
        ...
        _jsx(TableContainer, {
          ...
          children: _jsxs(Table, {
            size: "small",
            "aria-label": "Volunteer focus areas",
            children: [
              _jsx(TableHead, {
              ...
              _jsx(TableBody, {
                children: volunteerGroups.map((group) =>
                  _jsxs(
                    TableRow,
                    {
                      children: [
          ...
          children: visibleBlogs.map((b) =>
            _jsx(
              Grid,
              {
                size: { xs: 12, md: 6 },
                sx: { display: "flex" },
                children: _jsx(BlogCard, { blog: b, height: 240 }),
              },
              b.slug,
            ),
          ),
            ...
            children: _jsx(Card, {
              ...
              children: _jsxs(CardContent, {
                ...
                children: [
                  ...
                  _jsx(Typography, {
                    sx: { color: "text.secondary", lineHeight: 1.8 },
                    children: "Click to view the report inside this page.",
                  }),
                ],
              }),
            }),
  ...
  return _jsx(Box, {
    ...
    children: _jsxs(Container, {
      ...
      children: [
        ...
        _jsx(Box, {
          sx: { maxWidth: 920 },
          children: _jsx(MarkdownView, { markdown: blog.contentMarkdown }),
        }),
      ],
    }),
  });
  ...
  return _jsx(Box, {
    ...
    children: _jsx(Container, {
      ...
      children: _jsx(Grid, {
        ...
        spacing: 2.5,
        sx: { mt: 0 },
        children: explainers.map((explainer) =>
          _jsx(
            Grid,
            {
              size: { xs: 12, md: 6 },
    ...
    children: _jsxs(Container, {
      ...
      children: [
        ...
        _jsx(Box, {
          ...
          children: _jsx(Stack, {
            spacing: 2.4,
            children: explainer.paragraphs.map((paragraph) =>
              _jsx(
                Typography,
                {
                  sx: { color: "text.secondary", lineHeight: 1.9 },
          ...
          children: [
            ...
            opinion.downloadUrl && opinion.downloadFilename
              ? _jsx(Button, {
                  ...
                  children: "Download Word document",
                })
              : null,
          ],
        }),
        _jsxs(Box, {
          ...
          children: [
            ...
            opinion.contentMarkdown
              ...
              : _jsx(Stack, {
                  spacing: 2.4,
                  children: opinion.paragraphs?.map((paragraph, index) =>
                    _jsxs(
                      Box,
                      {
                        children: [
            ...
            opinion.downloadUrl && opinion.downloadFilename
              ? _jsx(Box, {
                  ...
                  children: _jsx(Button, {
                    ...
                    children: "Download full opinion (.docx)",
                  }),
                })
              : null,
          ],
...
export default function SitePages({ currentPath }) {
  if (currentPath === "/") return _jsx(HomePage, {});
  if (currentPath === "/about-us") return _jsx(AboutPage, {});
  if (currentPath === "/people") return _jsx(PeoplePage, {});
  if (currentPath === "/collaborators") return _jsx(CollaboratorsPage, {});
  if (currentPath === "/guidelines") return _jsx(GuidelinesPage, {});
  if (currentPath === "/events") return _jsx(EventsPage, {});
  if (currentPath === "/opinion") return _jsx(OpinionPage, {});
  ...
  if (currentPath === "/blogs") return _jsx(BlogsPage, {});
  if (currentPath === "/explainer") return _jsx(ExplainerPage, {});
