...
const explainers: Explainer[] = [
  {
    ...
    excerpt:
      "Gender sensitive, responsive, and transformative approaches describe different levels of action for addressing gender inequality in policies and programmes.",
    paragraphs: [
  ...
  },
  {
    ...
    excerpt:
      "Radical feminism centers patriarchy as the root of gender inequality and argues that social institutions must be fundamentally transformed.",
    paragraphs: [
  ...
  },
  {
    ...
    author: "Ishita Gupta",
    excerpt:
      "Ecofeminism examines the links between women and nature, arguing that both have historically faced exploitation and domination.",
    paragraphs: [
  ...
  },
  {
    ...
    author: "Riddhi Agnihotri",
    excerpt:
      "Gender fluidity describes a gender identity that can shift over time or across contexts rather than staying fixed.",
    paragraphs: [
